    ...
    portfolioCatBtns.forEach(btn => {
        btn.addEventListener('click', () => {
            ...
            if (category === 'identidad') {
                // Ocultar categorías y mostrar el grid de marcas
                ...
                if (brandsGridContainer) {
                    brandsGridContainer.style.display = 'flex';
                    renderBrandsGrid(window.redesData, 'GESTIÓN DE REDES', 'redes');
                }
                ...
                if (brandsGridContainer) {
                    brandsGridContainer.style.display = 'flex';
                    renderBrandsGrid(window.animacionData, 'ANIMACIÓN DIGITAL', 'animacion');
                }
